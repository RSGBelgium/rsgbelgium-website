...
<!--
Navigation list (follows scroll), now enabled via YAML sidebar: nav: organization
 {% include nav_list nav="organization" %} -->

<!--
Auto-generated ToC: works with single lay-out, but not splash/archive
use toc: true in YAML in the future. This also adds sub-title of feature_rows
{% include toc title="Organization of RSG Belgium" %} -->
