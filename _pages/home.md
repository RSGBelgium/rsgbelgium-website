...
intro:
  - excerpt: 'Welcome to the homepage of **RSG Belgium**, the Belgian branch of the <br>**ISCB Student Council''s Regional Student Groups**.<br>If you are interested in joining our network or if you just want to stay up to date on the latest RSG Belgium news, please check out our <br>announcements and upcoming activities in the [<i class="far fa-newspaper" aria-hidden="true"></i> news section](/news/), <br>follow our social media accounts [<i class="fab fa-twitter" aria-hidden="true"></i> Twitter](https://twitter.com/rsgbelgium) & [<i class="fab fa-facebook" aria-hidden="true"></i> Facebook](https://www.facebook.com/RSGBelgium), <br>come and have a chat on our [<i class="fab fa-slack" aria-hidden="true"></i> Slack channel](mailto:rsg-belgium@iscbsc.org?Subject=RSG%20Slack%20Subscription&Body=I%20would%20like%20to%20join%20the%20RSG%20Belgium%20Slack%20channel%2E) <br>or subscribe to the [<i class="fas fa-envelope-open" aria-hidden="true"></i> mailing list](http://listserver.ua.ac.be/sympa/subscribe/rsg-belgium).<br>We hope to see you at one of our upcoming events!'
feature_row:
